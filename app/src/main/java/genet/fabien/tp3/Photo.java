    ...
    public static ArrayList<Photo> initialiser (String pays) {
        ...
        switch(pays){
            ...
            case "fr":
                ...
                listePhotos.add(new Photo("La code d'Azur", "La Côte d’Azur est la partie orientale du littoral méditerranéen français et inclut la côte monégasque.","coteazur"));
